...
> *From slicing backend logic in Java & Laravel to automating workflows and administrating Linux servers — I chase excellence across every layer of the stack.*
...
![Postfix](https://img.shields.io/badge/Postfix-005F73?style=for-the-badge&logo=mail.ru&logoColor=white)
...
> Realtime GPS tracking, event logging, mobile-first UX
...
> Smart NLP-powered responses, Laravel backend, scalable architecture

`Laravel` `Gemini API` `AI`
...
### ⚙️ HR Automation Workflow
**Automated internship confirmation system**
> Email + voice messaging automation via n8n, zero manual intervention

`n8n` `Automation` `Postfix`

</td>
<td width="50%">

### 🛒 E-Commerce Platform
**Multi-vendor marketplace from scratch**
> Complete CRUD, auth, vendor dashboard, cart & checkout

`Laravel` `MySQL` `Full-Stack`
...
**Enterprise-level academic platform**
> Java/JEE architecture, role-based access, reporting system
...
> WebSockets, channels, DMs, file sharing — built like the real deal
...
<img src="https://komarev.com/ghpvc/?username=Bnsidi&color=00F5FF&style=for-the-badge&label=PROFILE+VIEWS" />
